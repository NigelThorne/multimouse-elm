...
Elm.Elm = Elm.Elm || {};
Elm.Elm.Client = Elm.Elm.Client || {};
Elm.Elm.Client.make = function (_elm) {
   "use strict";
   _elm.Elm = _elm.Elm || {};
   _elm.Elm.Client = _elm.Elm.Client || {};
   if (_elm.Elm.Client.values)
   return _elm.Elm.Client.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Elm.Client",
   $Basics = Elm.Basics.make(_elm),
   ...
   var receiveState = Elm.Native.Port.make(_elm).inboundSignal("receiveState",
   "String",
   function (v) {
   ...
   0,
   $Mouse.clicks);
   var pack = F3(function (id,
   x,
   y) {
      return {_: {}
             ,id: $Basics.toString(id)
             ,x: x
             ,y: y};
   });
   var sendInput = Elm.Native.Port.make(_elm).outboundSignal("sendInput",
   function (v) {
      return {id: v.id
             ,x: v.x
             ,y: v.y};
   ...
   $Html.text,
   receiveState);
   _elm.Elm.Client.values = {_op: _op
                            ,main: main
